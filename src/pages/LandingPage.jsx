        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {categories.map((cat) => (
              ...
              >
                <div className="f_category_icon_wrap" style={{ background: cat.color }}>
                  {cat.icon}
                </div>
                <div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={t} className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 text-white" style={{ background: bg }}>
                  {icon}
                </div>
                <div>
