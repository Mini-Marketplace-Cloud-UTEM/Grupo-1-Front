    ...
    <div className="f_landing_wrapper">
      ...
      <div className="px-6 py-8 md:px-12 md:py-12 space-y-12">
        ...
        <div
          ...
          className="f_hero_banner h-[320px] md:h-[360px] flex items-center justify-between px-8 md:px-14 relative"
        >
          <img
          ...
          <div className="relative z-10 max-w-xl flex flex-col justify-center">
            <span
              className="text-xs font-semibold tracking-widest uppercase mb-3 f_green_text"
            ...
            <h1
              className="text-3xl md:text-5xl font-extrabold leading-tight mb-4 text-white"
              style={{ marginLeft: '1rem' }}
            >
              Compra fácil, rápido y seguro en{' '}
              <span className="f_green_text font-black">
                MiniMarketPlace
              </span>
            </h1>

            <p
              className="text-sm md:text-base mb-6 f_text_muted max-w-md leading-relaxed"
              style={{ marginLeft: '1rem' }}
            >
              Explora las mejores ofertas en tecnología y productos para el
              hogar. Arma tu carrito sin registrarte; solo necesitas iniciar
              sesión para pagar.
            </p>

            <div className="flex items-center gap-3">
              <button
                className="f_green_btn px-6 py-3 text-sm md:text-base font-bold"
                style={{
                  marginLeft: '1rem',
                  padding: '0.5rem'
                }}
          ...
          <div className="hidden lg:flex flex-col gap-3 relative z-10">
            {[
              ...
              <div
                key={l}
                className="f_stat_card px-5 py-2.5 text-center min-w-[120px]"
              >
                <div className="text-lg font-bold f_green_text">
                  {n}
                </div>

                <div className="text-[10px] uppercase tracking-wider f_text_muted">
                  {l}
                </div>
              </div>
            ))}
          ...
          {loading ? (
            ...
            >
              {products.slice(0, 3).map((p) => (
                <div
                  key={p.id}
                  className="f_card_dark flex flex-col justify-between"
                ...
                >
                  <div className="relative overflow-hidden aspect-[4/3] bg-[#0B0F0E] rounded-t-2xl flex items-center justify-center">
                    ...
                    <div
                      className="product-img-placeholder flex items-center justify-center text-4xl"
                      style={{
                    ...
                    <span
                      ...
                      className="top-3 left-3 text-[10px] font-bold px-2.5 py-0.5 rounded-full f_badge_primary"
                    >
                      Vista Previa
                    </span>
                  </div>
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      <p
                        className="text-[10px] uppercase tracking-wider f_text_muted mb-1 font-semibold"
                        style={{ padding: '0.5rem' }}
                      >
                      ...
                      <h3
                        className="font-bold text-sm text-white line-clamp-2 h-10 leading-snug"
                        style={{ padding: '0.5rem' }}
                      >
                        {p.name}
                      </h3>
                    ...
                    <div>
                      <div className="flex items-end justify-between mb-4">
                        <div>
                          <p className="text-lg font-bold f_green_text font-mono">
                            {fmt(p.price)}
                          </p>
                        </div>
                      </div>
        ...
        <div
          style={{ padding: '1rem' }}
          className="pb-4 border-t f_border_dark pt-8"
        >
            ...
            {[
              {
                icon: <Truck size={20} />,
                t: 'Envío rápido',
                d: 'A todo Chile en 24-72 hrs',
                bg: '#1A3D2E'
              },
              {
                icon: <Shield size={20} />,
                t: 'Compra segura',
                d: 'Protección total en cada pago',
                bg: '#1E3A5F'
              },
              {
                icon: <CreditCard size={20} />,
                t: 'Cuotas sin interés',
                d: 'Hasta 12 cuotas con tarjeta',
                bg: '#3D2A1A'
              },
              {
                icon: <Package size={20} />,
                t: 'Devoluciones',
                d: '30 días para cambios',
                bg: '#2D1A3D'
              }
            ].map(({ icon, t, d, bg }) => (
              <div
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] md:text-xs f_text_muted mt-0.5">
                    {d}
                  </p>
                </div>
              </div>
